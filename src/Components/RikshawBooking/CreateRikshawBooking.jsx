...
function CreateRikshawBooking() {
  ...
  const ValidationSchema = Yup.object().shape({
    ...
    rikshawtype: Yup.string().required("Please Enter Labour Type"),
          ...
          <form onSubmit={formik.handleSubmit}>
            <Box className={formContainer}>
             ...
             <Box sx={{width:"49%"}}>
              ...
              <FormControl fullWidth>
                <Typography>Rikshaw Type</Typography>
                <TextField
                  name="rikshawtype"
                  value={formik.values?.rikshawtype}
                  size={"small"}
                  fullWidth
                  onChange={formik.handleChange}
                  type="text"
                  select
                  error={Boolean(formik.errors.rikshawtype) && Boolean(formik.touched.rikshawtype)}
                  helperText={Boolean(formik.errors.rikshawtype) && formik.errors.rikshawtype}
                >
                  <MenuItem value="">select</MenuItem>
                  <MenuItem value="Auto">Auto</MenuItem>
                  <MenuItem value="Chingchi">Chingchi</MenuItem>
...
export default CreateRikshawBooking;