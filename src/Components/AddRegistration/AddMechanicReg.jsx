           ...
           <Box sx={{width:"49%"}}>
            ...
            <FormControl fullWidth>
              ...
              <TextField
                ...
                onChange={formik.handleChange}
                type="number"
                error={Boolean(formik.errors.exptype) && Boolean(formik.touched.exptype)}
                helperText={Boolean(formik.errors.exptype) && formik.errors.exptype}
              />
            </FormControl>
            </Box>
            </Box>
            ...
            <FormControl fullWidth>
              ...
              <TextField
                ...
                fullWidth
                onChange={formik.handleChange}
                error={Boolean(formik.errors.shopname) && Boolean(formik.touched.shopname)}
                helperText={Boolean(formik.errors.shopname) && formik.errors.shopname}
              />
            </FormControl>
            </Box>
           <Box sx={{width:"49%"}}>
            ...
            <FormControl fullWidth>
              ...
              <TextField
                ...
                onChange={formik.handleChange}
                type="text"
                error={Boolean(formik.errors.shopaddress) && Boolean(formik.touched.shopaddress)}
                helperText={Boolean(formik.errors.shopaddress) && formik.errors.shopaddress}
              />
            </FormControl>
            </Box>
